...
package com.github.shannah.cn1test2;
 ...
 * @author Shai Almog
 */
public class Cn1Test2Stub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Cn1 Test2";
    private static final String APP_NAME = "cn1-test2";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new Cn1Test2Stub());
    }
